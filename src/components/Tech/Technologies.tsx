      ...
      <div className={styles.tech}>
        ...
        <div className={styles.grid}>
          {Object.keys((texts as any)[language].technologies)?.map((e: string) => (
            <div onClick={() => { handleActive(e) }} style={{ width: "150px", cursor: "pointer", backgroundColor: active === e ? "#384873" : 'transparent', padding: "8px", borderRadius: "10px", transition:"all 2s easy-in-out" }} key={e}><CardTech name={e} active={active === e ? true : false} />
            </div>
          ))}
